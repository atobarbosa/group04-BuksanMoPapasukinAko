...
Once the terminal shows that both the API and UI containers are running, open your web browser and go to `http://localhost:7860`. Upload your network log file to scan the network.
